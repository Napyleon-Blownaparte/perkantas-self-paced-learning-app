<x-app-layout>
    ...
    <div class="flex-1 p-8 ml-16">
        ...
        <h1 class="text-4xl font-bold mb-4">{{"Book Title here"}} by {{"Author"}}</h1>
    </div>
            ...
            <table class="min-w-full table-fixed">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-gray-900 py-2">Book Title here</td>
                    </tr>
                    <!-- Author -->
                    <tr>
                        <td class="font-semibold text-gray-700 py-2 w-32">Author:</td>
                        <td class="text-gray-900 py-2">Author</td>
                    </tr>
                    <!-- Description -->
                    <tr>
                        <td class="font-semibold text-gray-700 py-2 w-32 align-top">Description:</td>
                        <td class="text-gray-900 py-2">
                            <p class="break-words">Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.Ornare eleifend a egestas ex fringilla arcu curae viverra sem lobortis. Eu vitae duis ultrices ut arcu elementum dui malesuada. Inceptos faucibus pellentesque conubia id sollicitudin orci amet ut viverra. Dis consequat tortor efficitur phasellus adipiscing scelerisque.</p>
                        </td>
                    </tr>
                </tbody>
            </table>
