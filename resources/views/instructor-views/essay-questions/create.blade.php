        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('instructor.assessments.essay-questions.store', $assessment) }}" method="POST">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="answer_key" type="text" name="answer_key" :value="old('answer_key')" required
                                class="mt-1 block w-full p-2 border border-gray-300 rounded-md" />
                            <x-input-error :messages="$errors->get('answer_key')" class="mt-2" />
                        </div>

                        <x-primary-button type="submit">Create Essay Question</x-primary-button>
                    </form>
