    ...
    <div class="flex-1">
        <div class="bg-white">
            <section class="md:pb-16 pt-16 bg-gradient-to-r from-green-300 to-pink-200">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex items-center bg-none rounded-lg p-6  text-gray-950 m-4">
                        <div class="ml-2 p-4 relative z-10">
                            ...
                            <p class="text-4xl font-bold">What do you want to do today?</p>
                        </div>
                ...
                <!-- md:grid-cols-3 (If news is added) -->
                ...
                <div class="grid grid-cols-1 gap-6 py-6">
                    ...
                    <div class="bg-black p-6 rounded grid md:grid-cols-3 grid-flow-row grid-rows-1">
                        <div class="flex items-center">
                            <h2 class="text-5xl md:text-7xl text-white font-bold md:mb-4 mb-10">My courses</h2>
                        </div>
                        <div class="flex space-x-4 overflow-x-auto col-span-2">
                            @foreach ($courses as $course)
                                <div class="min-w-96 max-w-96 bg-gray-500 p-4 rounded shadow-md">
                                    <img src="{{asset('storage/'.$course->thumbnail_image) }}" alt="Course Image" class="w-full rounded h-96">
