    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6 ml-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                ...
                <!-- Add Courses -->
                <a href="{{ route('instructor.courses.create') }}" class="bg-white bg-cover bg-no-repeat bg-center bg-fit rounded-lg shadow-md p-6 flex flex-col items-center justify-center space-y-4 hover:bg-gray-100 transition-colors group">
                    <div class="flex items-center justify-center p-4 rounded-lg bg-white backdrop-blur-sm transition-colors group-hover:bg-gray-100">
