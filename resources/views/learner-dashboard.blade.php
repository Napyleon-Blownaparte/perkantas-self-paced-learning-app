<x-app-layout>
    ...
    <nav class="bg-white w-16 p-4 md:flex flex-col items-center justify-between shadow-lg fixed top-0 z-10 h-screen hidden">
        ...
        <div class="flex flex-col space-y-6 justify-center flex-grow">
            <a href="/courses" class="relative group p-2 text-gray-400 hover:text-gray-900 hover:bg-gray-200 rounded-lg">
                <!-- Icon  -->
                ...
                <span class="absolute left-full top-1/2 -translate-y-1/2 ml-4 w-max px-2 py-1 bg-gray-900 text-white text-xs 
                    rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    Courses
                </span>
            </a>
            <a href="/learner-dashboard" class="relative group p-2 text-gray-400 hover:text-gray-900 hover:bg-gray-200 
                rounded-lg bg-gray-200">
                <!-- Icon -->
                <svg width="35" height="35" viewBox="0 0 64 65" fill="none">
                    <path d="M34.6667 8.30859V24.3086H56V8.30859M34.6667 56.3086H56V29.6419H34.6667M8 56.3086H29.3333V40.3086H8M8 34.9753H29.3333V8.30859H8V34.9753Z" 
                        fill="#333333"/>
                </svg>
                <!-- Tooltip -->
                <span class="absolute left-full top-1/2 -translate-y-1/2 ml-4 w-max px-2 py-1 bg-gray-900 text-white text-xs 
                            ...
                            <div class="divide-y divide-gray-300">
                                    <div class="chapter-details mt-4 text-gray-600  overflow-y-auto h-48">
                                        <div class="divide-y divide-gray-300">
                                            ...
                                            <a href="{{ '/courses/' . $acceptedCourse->id }}"
                            ...
                            <div class="divide-y divide-gray-300">
                                    <div class="chapter-details mt-4 text-gray-600  overflow-y-auto h-48">
                                        <div class="divide-y divide-gray-300">
                                            ...
                                            <a href="{{ '/courses/' . $pendingCourse->id }}"
                                                class="flex items-center justify-between p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors duration-300 ease-in-out">
