        ...
        <div class="flex-1 p-6 ml-16">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-md p-6 flex flex-col items-center">
                    <h3
                        class="text-lg font-semibold mb-4 bg-white-50 p-2 rounded bg-white bg-opacity-50 backdrop-blur-sm">
                        Finished Course
                    </h3>
                ...
                <!-- Accepted Course -->
                <div
                    class="bg-white bg-cover bg-no-repeat bg-center bg-fit rounded-lg shadow-md p-6 flex flex-col items-center space-y-4">
                    <div
                        class="flex items-center justify-center mb-4 p-4 rounded-lg bg-white bg-opacity-50 backdrop-blur-sm">
            ...
            <!-- My Course-->
            <div
                class="w-full flex flex-col justify-center items-start p-4 bg-[url('../../public/images/pattern-background3.png')] bg-cover rounded-lg mt-8">
            ...
            <div
                ...
                <div class="flex items-center space-x-6">
                    <!-- Title on the left -->
                    <h1 class="text-3xl font-semibold mb-0 ml-4 mr-4 text-white text-center max-w-xs">Get Started With
                        Our Top Material</h1>
                    ...
                    <div class="flex overflow-x-auto whitespace-nowrap max-w-full space-x-6 py-4 rounded-lg">
                        ...
                        <x-enroll-course image_src="images/pattern-background1.png" title="Agama Hidup Bermakna"
                            est="50" link_url="#" />
                        <!-- Add additional cards here... -->
                    </div>
                </div>
