...
class UpdateMultiple_Choice_QuestionRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'option_1' => 'sometimes|required|string|max:255',
            'option_2' => 'sometimes|required|string|max:255',
            'option_3' => 'sometimes|required|string|max:255',
            'option_4' => 'sometimes|required|string|max:255',
            'correct_option' => 'sometimes|required|integer|in:1,2,3,4',
        ];
    }
